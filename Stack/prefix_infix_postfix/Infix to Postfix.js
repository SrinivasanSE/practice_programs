  ...
  infixToPostfix(s) {
    ...
    for (let char of s) {
      if (/[a-z0-9]/i.test(char)) {
        ...
        // ^ has right to left associativity, so for it, if the top element is also ^, it should not be popped. For others like "*", "/" with same precedency, stack will be popped as they left to right associativity
