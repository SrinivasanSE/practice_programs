...
The idea is to start picking from the last array. We pick the maximum element from the last array, 
then we move to the second last array. In the second last array, 
we find the largest element which is smaller than the maximum element picked from the last array. 
We repeat this process until we reach the first array.
